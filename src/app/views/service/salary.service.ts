...
export class SalaryService {
  ...
  private salaryBaseUrl = "/payroll-management/v1/salary-structure";
  private completeBasePath = this.apiServerUrl + this.salaryBaseUrl;
  ...
  public create(employeeId: number, basicSalary:number,bonus:number, effectiveFrom:string,
                active: boolean): Observable<any> {

    var postData = JSON.stringify({employeeId: employeeId, basicSalary: basicSalary, bonus:bonus,
