...
export class DeductionService {
  ...
  private deductionBaseUrl = "/payroll-management/v1/deduction";
  private completeBasePath = this.apiServerUrl + this.deductionBaseUrl;
  ...
  public create(name: string, description:string): Observable<any> {
    ...
    var postData = JSON.stringify({name: name, description: description});
