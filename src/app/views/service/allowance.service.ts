...
export class AllowanceService {
  ...
  private allowanceBaseUrl = "/payroll-management/v1/allowance";
  private completeBasePath = this.apiServerUrl + this.allowanceBaseUrl;
  ...
  public create(name: string, description:string, taxable:boolean): Observable<any> {

    var postData = JSON.stringify({name: name, description: description, taxable:taxable});
